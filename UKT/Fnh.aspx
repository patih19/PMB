<%@ Page Title="" Language="C#" MasterPageFile="~/UKT.Master" AutoEventWireup="true" CodeBehind="Fnh.aspx.cs" Inherits="UKT.WebForm12" %>
                                   ...
                                   Terimakasih</label>--%>
                                    <div class="col-lg-12 col-md-10 col-xs-12">
                                        ...
                                        <br />
                                            ...
                                            <hr />
                                           <h4><span>Biaya UKT Anda : </span> 
                                                <asp:Label ID="LbUktSNMPTN" runat="server" Font-Bold="True" CssClass="style5"></asp:Label> </h4> 
                                            </asp:Panel>
                                            ...
                                            <hr />
                                             <h4>Biaya UKT Anda : 
                                                <asp:Label ID="LbUktMandiri" runat="server" Font-Bold="True"></asp:Label> </h4><br />
                                                <h4><span class="style6">Pengumuman Untuk Jalur SM-UNTIDAR, Wajib Dicatat</span></h4>
                                                <div style="font-size:medium">
                                                <table class="table table-bordered">
                                                    <tr>
                                                        <td>a.</td>
                                                         <td>Pembayaran Uang Kuliah Tunggal</td>
                                                          <td>9-13 Agustus 2016</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            15 Agustus 2016</td>
                                                        <td>
                                                            baca persyaratan registrasi jalur SM-UNTIDAR pada laman
