<%@ Page Title="" Language="C#" MasterPageFile="~/op/Op.Master" AutoEventWireup="true" CodeBehind="lst.aspx.cs" Inherits="UKT.op.WebForm1" %>
            ...
            <div class="col-xs-12 col-md-12 col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading ui-draggable-handle">
                        <strong>Daftar Peserta Registrasi</strong></div>
                    <div class="panel-body">
                        <%--<table class="table-condensed">
                            <tr>
                                ...
                                <td>
                                <asp:TextBox ID="TBNpm" runat="server" MaxLength="10" Width="130px"
                        ...
                        <table class="table table-condensed">
                            <tr>
                                <td>Jalur</td>
                                 <td>
                                     <asp:DropDownList CssClass="form-control" ID="DlJalur" runat="server">
                                         <asp:ListItem>Pilih Jalur</asp:ListItem>
                                         <asp:ListItem>SNMPTN</asp:ListItem>
                                         <asp:ListItem>SBMPTN</asp:ListItem>
                                         <asp:ListItem>SMM-UNTIDAR</asp:ListItem>
                                     </asp:DropDownList>
                                 </td>
                                 <td>
                                     <asp:Button CssClass="btn btn-success" ID="BtnFilter" runat="server" Text="Search" />
                                 </td>
                            </tr>                            
                        </table>
                    ...
                    <div class="panel-footer">
                        <asp:Button ID="BtnFilterMhs" CssClass="btn btn-primary"  runat="server" Text="Cetak" OnClientClick="SetTarget();" />
                    </div>
                </div>
                <br />
                <br />
