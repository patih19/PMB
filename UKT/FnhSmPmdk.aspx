<%@ Page Title="" Language="C#" MasterPageFile="~/UKT.Master" AutoEventWireup="true" CodeBehind="FnhSmPmdk.aspx.cs" Inherits="UKT.WebForm16" %>
                                    ...
                                    <div class="col-lg-12 col-md-10 col-xs-12">
                                        ...
                                        <br />
                                            <table class="table-condensed">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <h4>
                                                            Biaya UKT Anda :
                                                            <asp:Label ID="LbUktPmdk" runat="server" Font-Bold="True"></asp:Label>
                                                        </h4>
                                                    </td>
                                                </tr>
                                            </table>
                                            <asp:Panel ID="PanelPMDKDiploma" runat="server">
                                            <hr />
                                                <h4><span class="style6">Pengumuman Untuk Jalur PMDK Diploma, Wajib Dicatat</span></h4>
                                                <div style="font-size:medium">
                                                <table class="table table-bordered">
                                                    <tr>
                                                        <td>a.</td>
                                                         <td>Pembayaran Uang Kuliah Tunggal</td>
                                                          <td>6-11 Juni 2017</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            12 Juni 2017</td>
                                                        <td>
                                                            Datang ke kampus Universitas Tidar, mekanisme daftar ulang dapat dilihat pada 
                                                            tautan
                                                            <asp:HyperLink ID="HyperLink1" runat="server" 
                                                                NavigateUrl="http://untidar.ac.id/berita/mekanisme-registrasi-daftar-ulang-calon-mahasiswa-baru-jalur-pmdk-universitas-tidar-tahun-2017/" 
                                                                Target="_blank">berikut</asp:HyperLink>
                                                        </td>
                                                    </tr>
                                                </table>
                                                </div>
                                            ...
                                            <asp:Panel ID="PanelPanduan" runat="server">
                                                ...
                                                <br />
                                                <h3>
                                                    <strong><span class="style4">PANDUAN PEMBAYARAN UKT</span></strong>
                                                </h3>
                                                <h4>
                                                    <strong>A. UNTUK WILAYAH JAWA TENGHAH :</strong></h4>

                                                <h4>
                                                    Pembayaran UKT melalui bank BDP Jawa Tengah, silahkan tunjukkan Nomor Pendaftaran PMDK Anda kepada teller BANK. Sebelum membayar tanyakan kepada Teller apakah pemabayrannya Online 
                                                    jika tidak silahkan pindah ke kantor Bank BDP Jateng yang lain, karena PIN Registrasi tidak didapat jika pembayarannya secara Manual/Offline </h4>
                                                <p>
                                                    &nbsp;</p>
                                                <h4>
                                                    <strong>B.UNTUK WILAYAH DI LUAR JAWA TENGAH / TIDAK DAPAT MENJANGKAU BANK BPD JATENG
                                                        :</strong></h4>
                                                <h4>
                                                    Pembayaran UKT melalui bank BNI dengan jenis pembayaran SKN(Kliring) dari Bank BNI
                                                    ke Bank BPD Jateng, berikut contoh formulir setoran dari Bank BNI yang ditujukan
                                                    kepada Bendahara Penerimaan Untidar Bank BPD Jawa Tengah melalui nomor rekening
                                                    1005004353, isilah formulir setoran sesuai petunjuk di bawah ini.</h4>
                                                <asp:Image ID="Image1" runat="server" ImageUrl="~/img/Kliring Jateng_.png" />
                                                <br />
                                                <br />
                                                <h4>
                                                    Tahap berikutnya scan bukti pembayaran dengan mesin pindai (scanner) kemudian unggah
                                                    bukti tersebut sesuai dengan ketentuan.</h4>
                                                <table class="table-condensed table-bordered">
                                                    <tr>
                                                        <td class="style5">
                                                            <h5>
                                                                <strong>Upload Slip/Kwitansi/Bukti Pembayaran</strong></h5>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="vertical-align: top">
                                                            ...
                                                            <table class="table-condensed" style="background-color: #C5E5C5">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="TbEmail" runat="server" CssClass="form-control" TextMode="Email"
                                                                            Placeholder="ISIKAN ALAMAT EMAIL AKTIF"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <asp:Button ID="BtnUpload" CssClass="btn btn-primary" runat="server" Text="Upload (KHUSUS BANK BNI)"
                                                                            OnClick="BtnUpload_Click" OnClientClick="return confirm('Anda Yakin Alamat Email Sudah Benar ?');" />
                                                                        &nbsp;<h5>
                                                                            <span class="style6">Periksa kembali alamat email sebelum unggah berkas </span>
                                                                        </h5>
                                                                    </td>
                                                                </tr>
                                                            </table>
