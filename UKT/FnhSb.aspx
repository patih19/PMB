<%@ Page Title="" Language="C#" MasterPageFile="~/UKT.Master" AutoEventWireup="true" CodeBehind="FnhSb.aspx.cs" Inherits="UKT.WebForm14" %>
                                   ...
                                   Terimakasih</label>--%>
                                    <div class="col-lg-12 col-md-10 col-xs-12">
                                        ...
                                        <br />
                                                    ...
                                                    <td>
                                                        ...
                                                        <h4>
                                                            ...
                                                            mahasiswa baru akan kami umumkan melalui laman <a href="http://untidar.ac.id" target="_blank">
                                                                untidar.ac.id</a> 
                                                            dan <a href="http://registrasi.untidar.ac.id" target="_blank">
                                                                registrasi mahasiswa baru</a></h4>
                                                                <hr />
                                                        <h4>
                                                            ...
                                                            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="style4" 
                                                                onclick="LinkButton1_Click">download</asp:LinkButton>
                                                                                                     ...
                                                                                                     <h4>Biaya UKT Anda : 
                                                <asp:Label ID="LbUktSBMPTN" runat="server" Font-Bold="True"></asp:Label> </h4>
                                                    </td>
                                                </tr>
                                            </table>
                                            <asp:Panel ID="PanelSBMPTN" runat="server">
                                            <hr />
                                                <h4><span class="style6">Pengumuman Untuk Non Bidik Misi, Wajib Dicatat</span></h4>
                                                <div style="font-size:medium">
                                                <table class="table table-bordered">
                                                    <tr>
                                                        <td>a.</td>
                                                         <td>Pembayaran Uang Kuliah Tunggal</td>
                                                          <td>3-11 Juli 2017</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            10-11 Juli 2017</td>
                                                        <td>
                                                            baca persyaratan registrasi jalur SBMPTN pada laman
                                                            <a target="_blank" href="http://registrasi.untidar.ac.id">registrasi.untidar.ac.id</a></td>
                                                    </tr>
                                                </table>
                                                </div>
                                            </asp:Panel>
                                            ...
                                            <h4><strong><span class="style4">PANDUAN PEMBAYARAN UKT</span></strong> </h4> 
                                                <h4>
                                                    <strong>A. UNTUK WILAYAH JAWA TENGHAH :</strong></h4>

                                                <h4>
                                                    Pembayaran UKT melalui bank BDP Jawa Tengah, silahkan tunjukkan Nomor SBMPTN 
                                                    Anda kepada Teller Bank. Sebelum membayar tanyakan kepada Teller apakah 
                                                    pemabayarannya Online jika tidak silahkan pindah ke kantor Bank BDP Jateng yang 
                                                    lain, karena PIN Registrasi tidak didapat jika pembayarannya secara 
                                                    Manual/Offline</h4>
                                                    <p></p>
                                                    <br />
                                                <h4>
                                                    <strong>B. UNTUK WILAYAH DI LUAR JAWA TENGAH / TIDAK DAPAT MENJANGKAU BANK BPD 
                                                    JATENG :</strong></h4>
                                                <h4>
                                                    ...
                                                    1005004353, isilah formulir setoran sesuai petunjuk di bawah ini.
                                                </h4>
                                                <asp:Image 
                                                    ID="Image1" runat="server" ImageUrl="~/img/Kliring Jateng_.png" />
                                                <br />
                                                <br />
                                                <h4>
                                                    Tahap berikutnya scan bukti pembayaran dengan mesin pindai (scanner) kemudian 
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="TbEmail" runat="server" CssClass="form-control" 
                                                                            Placeholder="ISIKAN ALAMAT EMAIL AKTIF" TextMode="Email"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <asp:Button ID="BtnUpload" runat="server" CssClass="btn btn-primary" 
                                                                            ...
                                                                            onclientclick="return confirm('Anda Yakin Alamat Email Sudah Benar ?');" 
                                                                            Text="Upload (KHUSUS BANK BNI)" />
                                                                        &nbsp;<h5>
