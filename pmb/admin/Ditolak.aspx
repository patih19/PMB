<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="Ditolak.aspx.cs" Inherits="pmb.admin.WebForm4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/jscript">
        $(document).ready(function () {
            $('#ContentPlaceHolder1_GVHasilDitolak').DataTable({
                'iDisplayLength': 100,
    ...
    <style type="text/css">
        table#ContentPlaceHolder1_GVHasilDitolak tr:hover { background-color :#d9edf7; }
        th { color:White !important; background-color:rgb(51, 123, 102); }
        table#ContentPlaceHolder1_GVHasilDitolak tbody tr:nth-child(odd){ background-color :#fff;}
        table#ContentPlaceHolder1_GVHasilDitolak tbody tr:nth-child(odd){ background-color :#EEF7EE;}
    </style> 
</asp:Content>
                ...
                <asp:Panel ID="PanelAddPeserta" runat="server">
                    <div class="panel panel-default">
                        <div class="panel-heading ui-draggable-handle">
                            <strong>DATA PESERTA TIDAK DITERIMA</strong></div>
                        <div class="panel-body">
                            <asp:GridView ID="GVHasilDitolak" runat="server" CssClass="table table-condensed table-bordered table-striped table-hover"
                                OnRowDataBound="GVHasilDitolak_RowDataBound" OnPreRender="GVHasilDitolak_PreRender">
                            </asp:GridView>
                        </div>
