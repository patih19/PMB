<%@ Page Title="" Language="C#" MasterPageFile="~/sm/sm.Master" AutoEventWireup="true" CodeBehind="today.aspx.cs" Inherits="pmb.sm.WebForm5" EnableEventValidation="false" %>
    ...
    <div class="container top-buffer" style="background-color: #F2F2FF;">
        <div class="row">
            <div class="col-xs-6 col-md-8 col-lg-9">
                <strong><span class="style5">Daftar Pendaftar Hari Ini:<br />
                </span></strong>
                <br />
                Lihat&nbsp;Pendaftar 
                berdasarkan tanggal daftar :<br />
                <table class="table-condensed table-bordered">
                    <tr>
                        <td>&nbsp;Tanggal</td>
                        <td>
                            <asp:TextBox ID="TbTgl1" runat="server" MaxLength="10" CssClass="form-control" 
                                Width="100px"></asp:TextBox>
                            <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TbTgl1"
                                Format="yyyy-MM-dd">
                            </asp:CalendarExtender>
                        </td>
                        <td>sampai </td>
                        <td>
                            <asp:TextBox ID="TbTgl2" runat="server" MaxLength="10" CssClass="form-control" 
                                Width="100px"></asp:TextBox>
                            <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="TbTgl2"
                                Format="yyyy-MM-dd">
                            </asp:CalendarExtender>
                        </td>
                        <td>
                ...
                <asp:GridView ID="GVToday" runat="server" CellPadding="4" ForeColor="#333333" 
                    GridLines="None" CssClass="table-condensed table-bordered" PageSize="75">
