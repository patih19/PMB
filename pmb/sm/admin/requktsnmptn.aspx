<%@ Page Title="" Language="C#" MasterPageFile="~/sm/sm.Master" AutoEventWireup="true" CodeBehind="requktsnmptn.aspx.cs" Inherits="pmb.sm.WebForm16" %>
    ...
    <div class="container top-buffer" style="background-color: #F2F2FF;">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-8 col-lg-10">
                <strong><span class="style5">Validasi Bukti Pembayaran UKT Jalur SNMPTN :
                </span></strong>
                <br /><br />
                    <asp:GridView ID="GVListReqSNMPTN" CssClass="table-bordered table-condensed" 
