<%@ Page Title="" Language="C#" MasterPageFile="~/sm/sm.Master" AutoEventWireup="true" CodeBehind="cabut.aspx.cs" Inherits="pmb.sm.WebForm7" %>
    ...
    <div class="container top-buffer" style="background-color: #F2F2FF;">
        <div class="row">
            <div class="col-xs-6 col-md-8 col-lg-9">
                <strong><span class="style5">Daftar Pendaftaran Cabut:<br />
                </span></strong>
                <br />
                ...
                <asp:Panel ID="PanelPesertaCabut" runat="server">
                    <asp:GridView ID="GVCabut" runat="server" CellPadding="4" 
