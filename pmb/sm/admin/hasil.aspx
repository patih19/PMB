<%@ Page Title="" Language="C#" MasterPageFile="~/sm/sm.Master" AutoEventWireup="true" CodeBehind="hasil.aspx.cs" Inherits="pmb.sm.WebForm9" %>
    ...
    <div class="container top-buffer" style="background-color: #F2F2FF;">
        <div class="row">
            <div class="col-xs-6 col-md-8 col-lg-9">
                <strong><span class="style5">Daftar Pendaftar Diterima:<br />
                </span></strong>
                <br />
                ...
                <br />
                Program Studi :
                <asp:Label ID="LbProdi" runat="server" Text="-"></asp:Label>
                <br />
