<%@ Page Title="" Language="C#" MasterPageFile="~/sm/sm.Master" AutoEventWireup="true" CodeBehind="PendaftaranSm.aspx.cs" Inherits="pmb.sm.WebForm21" %>
    ...
    <div class="container top-buffer" style="background-color: #F2F2FF;">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-8 col-lg-9">
                ...
                <br /><br />
                    <asp:GridView ID="GVListDaftarSM" CssClass="table-bordered table-condensed" 
