<%@ Page Title="" Language="C#" MasterPageFile="~/sm/sm.Master" AutoEventWireup="true" CodeBehind="BerkasMundur.aspx.cs" Inherits="pmb.sm.WebForm11" %>
    ...
    <div class="container top-buffer" style="background-color: #F2F2FF;">
        <div class="row">
            <div class="col-xs-6 col-md-8 col-lg-9">
                <strong><span class="style5">Input pendaftar cabut / mengundurkan diri:<br />
                </span></strong>
                <br />
                proses ini dilakukan didalam masa pendaftaran / sebelum penutupan
