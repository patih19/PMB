<%@ Page Title="" Language="C#" MasterPageFile="~/sm/sm.Master" AutoEventWireup="true" CodeBehind="requktsbmptn.aspx.cs" Inherits="pmb.sm.WebForm17" %>
    ...
    <div class="container top-buffer" style="background-color: #F2F2FF;">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-8 col-lg-9">
                <strong><span class="style5">Validasi Bukti Pembayaran UKT Jalur SBMPTN:
                </span></strong>
                <br /><br />
                    <asp:GridView ID="GVListReqSBMPTN" CssClass="table-bordered table-condensed" 
