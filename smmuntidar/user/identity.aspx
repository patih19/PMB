<%@ Page Title="" Language="C#" MasterPageFile="~/user/SMM.Master" AutoEventWireup="true" CodeBehind="identity.aspx.cs" Inherits="smmuntidar.user.WebForm14" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p></p>
        ...
        <div class="row">
            <div class="col-md-9">
                <strong><span class="style3">Tahap Ke-2 : Identitas Diri</span></strong><br />
                <br />
