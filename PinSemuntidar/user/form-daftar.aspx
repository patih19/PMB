<%@ Page Title="" Language="C#" MasterPageFile="~/user/User.Master" AutoEventWireup="true" CodeBehind="form-daftar.aspx.cs" Inherits="PinSemuntidar.user.WebForm9" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="container top-buffer"  style="background-color: #F2F2FF;">
            <div class="row">
                <div class="col-md-9">
                    <br />
                Selamat datang di Website Pendaftaran Peserta SM-UNTIDAR (Seleksi Masuk Universitas Tidar). Situs Web ini khusus disediakan bagi Calon Peserta SM-UNTIDAR
                ...
                Untuk membantu proses pendaftaran ini berjala lancar perhatikan beberapa hal berikut di bawah ini :
                    ...
                    <br />
                    Untuk Proses Selanjutnya masuklah ke Pendaftaran Online
                    <br />
                    <br />
                    <br />
                    <br />
