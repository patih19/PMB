<%@ Page Title="" Language="C#" MasterPageFile="~/user/User.Master" AutoEventWireup="true" CodeBehind="pendidikan.aspx.cs" Inherits="smuntidar.user.WebForm9" EnableEventValidation="false" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TbSMAAsal" runat="server" Width="240px"></asp:TextBox><br />
                             <span class="style4">contoh: SMK Negeri 1 Magelang</span></td>
                    </tr>
                    <tr>
                        <td>
                            Status Sekolah:
