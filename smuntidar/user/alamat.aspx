<%@ Page Title="" Language="C#" MasterPageFile="~/user/User.Master" AutoEventWireup="true" CodeBehind="alamat.aspx.cs" Inherits="smuntidar.user.WebForm1" EnableEventValidation="false" %>
            ...
            <div class="col-md-9">
                ...
                <table class="table-condensed table-bordered" align="center">
                    ...
                    <tr>
                        ...
                        <td class="text-left">
                            <asp:TextBox ID="TbEmail" runat="server" MaxLength="25"></asp:TextBox>
                            <br />
