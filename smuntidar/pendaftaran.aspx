<%@ Page Title="" Language="C#" MasterPageFile="~/Daftar.Master" AutoEventWireup="true" CodeBehind="pendaftaran.aspx.cs" Inherits="smuntidar.WebForm6" EnableEventValidation="false" %>
...
<div class="container top-atas" style="background-color: #F2F2FF;">
    <div class="container top-atas" style="background-color: #F2F2FF;">
        ...
        <div class="row">
            ...
            Selamat Datang di Website Seleksi Masuk Universitas Tidar (SM-UNTIDAR). Website ini diracang sebagai pusat informasi penerimaan mahasiswa baru jalur Mandiri 
            yang dikelola sepenuhnya oleh Universitas Tidar. SM-UNTIDAR adalah salah satu sistem penerimaan mahasiswa baru jalur Mandiri yang proses penerimaannya 
                dikelola dengan mempertimbangkan nilai dan prestasi dari calon mahasiswa. Melalui website ini semua informasi mengenai penerimaan mahasiswa 
                baru khususnya SM-UNTIDAR dapat diperoleh secara up-to-date.
                <br /><br />
                <div class=" col-xs-12 col-md-8 col-lg-8 ">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            Statistik 
                            Pendaftaran Tiap Program Studi</div>
                        <div class="panel-body">
                            <asp:GridView ID="GVProdi" CssClass="table table-striped" runat="server" CellPadding="4" ForeColor="#333333" 
                                GridLines="None">
            ...
            <div class="col-xs-4 col-md-3 col-lg-3  highlight">
                 <div class="panel panel-warning">
                    <div class="panel-heading">
                        <h4><asp:HyperLink ID="HyperLink4" runat="server" 
                                NavigateUrl="https://drive.google.com/file/d/0B9QhYV69qy4bZkpKODdfSVFrN0E/view?usp=sharing" 
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <hr />
                        Untuk melakukan login, isi nomor Pendaftaran dan PIN (case sensitive) yang tertera pada
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="https://drive.google.com/file/d/0B9QhYV69qy4bV0NCWkQ3S1BWZlU/view?usp=sharing" 
                            Target="_blank">A. Pendaftaran & Pembayaran di Bank Jateng</asp:HyperLink> <br />
                ...
                <div class="panel panel-danger">
                   ...
                   Upload Bukti Pembayaran</div>
                    ...
                    bagi peserta yang membayar selain di bank Bank Jateng. 
                        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/ValUp.aspx" 
