...
namespace smuntidar
{
    public partial class WebForm5 : System.Web.UI.Page
    {
            ...
            if (this.Captcha2.UserValidated)
            {
                ...
                using (SqlConnection con = new SqlConnection(CS))
                {
                    ...
                    try
                    {
                        ...
                        CmdTagihan.Parameters.AddWithValue("@no_pendaftaran",this.TBNoDaftar.Text);
                        ...
                        this.Lbtg.Text = no_jurnal.Value.ToString();
                        this.Lbemail.Text = email.Value.ToString();
        ...
        {
            get { return this.Lbtg.Text; }
        }

        public string Email
        {
            get { return this.Lbemail.Text; }
        }
    }
}